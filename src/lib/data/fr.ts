export default 
{
    ...
    project:
    {
        after_impact :
        {
            ...
            overview : "After Impact est un jeu pour lequel j'ai participé lors de ma troisième année à Créajeux, en 2026. Notre équipe était composée de 8 programmeurs, et 4 artistes graphiques, et avec 5 mois pour produire un jeu jouable, nous devions souvent équilibrer nos ambition techniques selon notre temps et nos ressources disponibles. Pour la programmation, nous avons utilisé Unity, C#, FMOD, Visual Studio en tant qu'IDE et SVN en tant que VCS (système de contrôle de version).",
            ImgForShow : 
            {   
